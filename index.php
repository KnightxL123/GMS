		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 m-auto text-white">
					<h2>Home</h2>
					<p>Get fit, feel great! Join our gym today and start your journey to a healthier you.</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="pricing-section spad">
		<div class="container">
			...
			<img src="img/icons/logo-icons.png" alt="">
				<h2>Pricing plans</h2>
				<p>Warning: Side effects of working out may include accidental hotness🔥</p>
			</div>
			<div class="row">
				        <?php 
